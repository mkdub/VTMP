...
/*-----------------------------------------------------------------------------------*/
		...
		<div class="comment-wrap">
			...
			<h3 class="comments-title"><?php comments_number(__('No Comments', 'engine'), __('One Comment', 'engine'), __('% Comments', 'engine')); ?></h3>
...
/*-----------------------------------------------------------------------------------*/
	...
	<div id="respond" class="clearfix">
		...
		<h3><?php comment_form_title( __('Leave a Comment', 'engine'), __('Leave a Comment to %s', 'engine') ); ?></h3>
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<div class="textarea-wrap">
				...
				<p><textarea placeholder="<?php _e('Your comment…', 'engine'); ?>" name="comment" id="comment" cols="58" rows="10" tabindex="4"></textarea></p>
			...
			<div class="input-wrap">
				...
				<p>
				<label for=""><?php _e('Name *', 'engine') ?></label>
				<input type="text" placeholder="<?php _e('Name *', 'engine') ?>" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" size="22" tabindex="1" />
				</p>
			
				<p>
				<label for=""><?php _e('Email Address *', 'engine') ?></label>
				<input type="text" placeholder="<?php _e('Email Address *', 'engine') ?>" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" />
				</p>
			
				<p>
				<label for=""><?php _e('Website', 'engine') ?></label>
				<input type="text" placeholder="<?php _e('Website', 'engine') ?>" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" size="22" tabindex="3" />
				</p>
				
			
				<?php endif; ?>
				
				<p><input name="submit" type="submit" class="submit" tabindex="5" value="<?php _e('Submit Comment', 'engine') ?>" />
