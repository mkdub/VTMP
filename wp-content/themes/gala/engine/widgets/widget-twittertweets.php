...
function dt_twitter_js($dt_twitter_username, $dt_twitter_postcount) {
		...
		<script type="text/javascript" src="http://api.twitter.com/1/statuses/user_timeline.json?screen_name='.$dt_twitter_username.'&amp;include_rts=true&amp;count='.$dt_twitter_postcount.'&amp;callback=twitterCallback2"></script>';
}
