...
function dt_tiny_mce_before_init($settings) {
	$style_formats = array(
		...
		array( 'title' => 'Buttons' ),
		array( 'title' => 'White Button', 'inline' => 'span', 'classes' => 'button white' ),
		array( 'title' => 'Grey Button', 'inline' => 'span', 'classes' => 'button grey' ),
		array( 'title' => 'Yellow Button', 'inline' => 'span', 'classes' => 'button yellow' ),
		array( 'title' => 'Green Button', 'inline' => 'span', 'classes' => 'button green' ),
		array( 'title' => 'Blue Button', 'inline' => 'span', 'classes' => 'button blue' ),
		array( 'title' => 'Black Button', 'inline' => 'span', 'classes' => 'button black' ),
