<div class="options-home cf">
	...
	<div class="cf">
		...
		<div class="lg box first home-tab-link" id="dt-design-settings">
			<h4><a rel="#design-tab" href="#design-tab" class="home-tab-link"><?php _e('Design/Branding Settings', 'engine'); ?></a></h4>
			<p><?php _e('Design, branding and responsive layout settings', 'engine'); ?></p>
		</div>
		...
		<div class="lg box home-tab-link" id="dt-homepage-settings">
			...
			<p><?php _e('Homepage welcome message and featured posts options', 'engine'); ?></p>
		</div>
		...
		<div class="lg box first home-tab-link" id="dt-display-settings">
			...
			<p><?php _e('Single and Portfolio post display options', 'engine'); ?></p>
		</div>
